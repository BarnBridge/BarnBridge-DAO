...
import "../storage/GovernanceStorageContract.sol";
import "../storage/ERC20TokenStorageContract.sol";


contract Governance is GovernanceStorageContract, ERC20TokenStorageContract {
    ...
    function newProposal(address _proposalContract, uint _endTime) external returns (uint proposalId) {
        uint contractSize;
